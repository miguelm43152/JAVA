...
/************************* Esta clase ayuda con el espaciamiento de entidades dadas su cantidad, dimensiones, el espacio requerido de separacion  **************/
/************************* y las dimensiones del contenedor que se desea abarcar  *****************************************************************************/
...
public class OrdenMatriz{
	...
	//n: numero de elementos en x o y.
		...
		//-----------regresa un valor verdadero para elementos positivos (esquina y centro) y falso para aristas.-----------
		boolean calculaAdjunto(int iteradori, int iteradorj){ 
			boolean b;
