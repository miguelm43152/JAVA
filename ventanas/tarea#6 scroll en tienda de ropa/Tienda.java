...
//variable que nos indica que el boton ya se ha presionado
	...
	JScrollPane panelDeslizable = new JScrollPane( cuadroTexto);
...
//		cuadroTexto.setBounds(  420, e.getPosicionY(0) , 325, 150);
		panelDeslizable.setBounds(  420, e.getPosicionY(0) , 325, 150);
